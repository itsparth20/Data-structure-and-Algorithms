	...
	protected void paintComponent(Graphics g) {
		...
		if (c == CellColors.NO_FLYING) {
			...
			if (c == CellColors.CUSTOMER_PROCESSED || c == CellColors.INITIAL_PROCESSED)
				gp = new GradientPaint(hexX[5], hexY[5], palette.initialGradient(CellColors.IN_STACK), hexX[1], hexY[1],
			...
			displayed = true;
		} else if (c == CellColors.THIEF || c == CellColors.THIEF_PUSHED || c == CellColors.THIEF_POPPED) {
			...
			} else if (c == CellColors.THIEF_PUSHED) {
			...
			g2d.drawImage(img, 0, 0, width, width, null);
			displayed = true;
		} else if (c == CellColors.HIGH_ALTITUDE || c == CellColors.HIGH_ALTITUDE_PUSHED
				|| c == CellColors.HIGH_ALTITUDE_POPPED) {
			...
			} else if (c == CellColors.HIGH_ALTITUDE_PUSHED) {
